import type { Todo } from "@open-agent-harness/sdk/v2"
import { AnimatedNumber } from "@open-agent-harness/ui/animated-number"
import { Checkbox } from "@open-agent-harness/ui/checkbox"
import { DockTray } from "@open-agent-harness/ui/dock-surface"
import { IconButton } from "@open-agent-harness/ui/icon-button"
import { useSpring } from "@open-agent-harness/ui/motion-spring"
import { TextReveal } from "@open-agent-harness/ui/text-reveal"
import { TextStrikethrough } from "@open-agent-harness/ui/text-strikethrough"
