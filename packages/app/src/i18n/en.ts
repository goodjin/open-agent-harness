export const dict = {
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Open Agent Harness does not support MCP authentication yet.',
  ...
  "settings.general.row.colorScheme.description": "Choose whether Open Agent Harness follows the system, light, or dark theme",
