export const dict = {
  ...
  "session.runs.fallbackHint": "Source: fallback summary generated after the child result could not be recorded normally.",
  ...
  "sessionTree.noResumable.description": "Enable completed sessions if you want to send resume commands to completed or idle sessions.",
