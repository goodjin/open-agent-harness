export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Open Agent Harness",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Open Agent Harness.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Open Agent Harness Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Open Agent Harness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Open Agent Harness.",
  ...
  "provider.custom.field.concurrency.label": "Provider concurrency",
  "provider.custom.field.concurrency.placeholder": "Optional",
  "provider.custom.field.concurrency.description": "Maximum concurrent model requests for this provider.",
  "provider.custom.field.rpm.label": "Provider RPM",
  "provider.custom.field.rpm.placeholder": "Optional",
  "provider.custom.field.rpm.description": "Maximum model requests per minute for this provider.",
  ...
  "provider.custom.models.concurrency.label": "Concurrency",
  "provider.custom.models.concurrency.placeholder": "Limit",
  "provider.custom.models.rpm.label": "RPM",
  "provider.custom.models.rpm.placeholder": "RPM",
  ...
  "provider.custom.error.concurrency": "Use a positive whole number",
  "provider.custom.error.rpm": "Use a positive whole number",
  ...
  "prompt.toast.agentRequired.description": "Choose an agent before sending a prompt.",
  "prompt.toast.modelRequired.title": "Select a model",
  "prompt.toast.modelRequired.description": "Choose a model before sending a prompt.",
  ...
  "dialog.server.description": "Switch which Open Agent Harness server this app connects to.",
  ...
  "toast.update.description": "A new version of Open Agent Harness ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Open Agent Harness team",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" failed. Note, Open Agent Harness does not support MCP authentication yet.',
  ...
  "session.tab.runs": "Runs",
  "session.tab.task": "Task",
  ...
  "session.logs.empty": "No logs in this session yet",
  "session.logs.error": "Unable to load session logs",
  "session.logs.refresh": "Refresh",
  ...
  "session.logs.stats.reasoning": "Reasoning",
  "session.logs.stats.cacheRead": "Cache read",
  "session.logs.stats.cacheWrite": "Cache write",
  "session.runs.title": "Tasks",
  "session.runs.count": "{{count}} tasks",
  "session.runs.loading": "Loading tasks...",
  "session.runs.empty": "No tasks in this session yet",
  "session.runs.error": "Unable to load session runs",
  "session.runs.refresh": "Refresh",
  "session.runs.task": "Task",
  "session.runs.result": "Result",
  "session.runs.execution": "Execution",
  "session.runs.recorded": "Recorded",
  "session.runs.fallback": "Fallback",
  "session.runs.fallbackHint":
    "Source: fallback summary generated after the child result could not be recorded normally.",
  "session.runs.missingResult": "Final result not recorded",
  "session.runs.running": "Running",
  "session.runs.status.running": "Running",
  "session.runs.status.completed": "Completed",
  "session.runs.status.blocked": "Blocked",
  "session.runs.status.failed": "Failed",
  "session.runs.runID": "Run ID {{id}}",
  "session.runs.started": "Started {{time}}",
  "session.runs.completedAt": "Completed {{time}}",
  "session.runs.documentCount": "{{count}} docs",
  "session.runs.startedLabel": "Started",
  "session.runs.completed": "Completed",
  "session.runs.progressLabel": "Progress",
  "session.runs.progress": "{{done}}/{{total}} subtasks completed",
  "session.runs.duration": "Duration",
  "session.runs.metrics": "Metrics",
  "session.runs.metricActions": "{{count}} actions",
  "session.runs.metricInternal": "{{count}} internal tool calls",
  "session.runs.metricModel": "{{count}} model tool calls",
  "session.runs.metricVisible": "{{count}} visible bytes",
  "session.runs.metricRaw": "{{count}} raw bytes",
  "session.runs.executionSummary": "Executor summary",
  "session.runs.tasks": "Subtasks",
  "session.runs.depends": "Depends on {{ids}}",
  "session.runs.documents": "Documents",
  "session.runs.noDocuments": "No documents recorded for this task",
  "session.runs.documentLoading": "Loading document...",
  "session.runs.documentError": "Unable to load document",
  "session.runs.back": "Back to run",
  "session.task.loading": "Loading current task...",
  "session.task.current": "Current task",
  "session.task.archived": "Archived version {{version}}",
  "session.task.meta": "Version {{version}} · Updated {{time}}",
  "session.task.history": "View history",
  "session.task.return": "Return to current",
  "session.task.progress": "Progress and actions",
  "session.task.progressValue": "{{completed}}/{{total}} actions completed",
  "session.task.result": "Task result",
  "session.task.result.running": "This task is still running ({{completed}}/{{total}} actions completed).",
  "session.task.result.recorded": "Recorded result",
  "session.task.result.fallback": "Fallback result",
  "session.task.result.missing": "Final result not recorded",
  "session.task.handoffs": "Related handoffs",
  "session.task.handoffs.empty": "No related handoffs",
  "session.task.handoff.target": "Target session {{session}}",
  "session.task.handoff.proposed": "Proposed",
  "session.task.handoff.confirmed": "Confirmed",
  "session.task.handoff.creating": "Creating",
  "session.task.handoff.started": "Started",
  "session.task.handoff.failed": "Failed",
  "session.task.handoff.cancelled": "Cancelled",
  "session.task.proposal.update": "Task update proposal",
  "session.task.proposal.handoff": "Task handoff proposal",
  "session.task.proposal.children": "Affected child sessions: {{sessions}}",
  "session.task.proposal.ownership": "Ownership: a separate peer task outside the current session tree.",
  "session.task.proposal.refs": "Reusable context: {{refs}}",
  "session.task.proposal.confirm": "Confirm",
  "session.task.proposal.retry": "Retry",
  "session.task.proposal.discuss": "Continue discussing",
  "session.task.proposal.cancel": "Cancel proposal",
  "session.task.proposal.openTarget": "Open target session",
  "session.task.proposal.status.proposed": "Proposed",
  "session.task.proposal.status.confirming": "Confirming",
  "session.task.proposal.status.revising": "Revising",
  "session.task.proposal.status.creating": "Creating",
  "session.task.proposal.status.started": "Started",
  "session.task.proposal.status.failed": "Failed",
  "session.task.proposal.status.cancelled": "Cancelled",
  "session.task.action.pending": "Pending",
  "session.task.action.running": "Running",
  "session.task.action.completed": "Completed",
  "session.task.action.blocked": "Blocked",
  "session.task.action.failed": "Failed",
  "session.task.action.skipped": "Skipped",
  "session.task.history.loading": "Loading task history...",
  "session.task.history.empty": "No archived task revisions",
  "session.task.history.version": "Version {{version}}",
  "session.task.history.terminal": "Terminal: {{status}}",
  "session.task.history.stopped": "Stopped children: {{count}}",
  "session.task.history.result": "Result: {{status}}",
  "session.task.history.result.completed": "Complete",
  "session.task.history.result.partial": "Partial",
  "session.task.history.result.failed": "Failed",
  "session.task.history.result.missing": "Not recorded",
  ...
  "session.task.status.revising": "Revising",
  "session.task.status.blocked": "Blocked",
  "session.task.status.completed": "Completed",
  "session.task.status.failed": "Failed",
  "session.task.status.archived": "Archived",
  "session.task.error.current": "Unable to load the current task",
  "session.task.error.history": "Unable to load task history",
  "session.task.error.detail": "Unable to load the archived revision",
  ...
  "session.followupDock.target": "Replying to {{target}}",
  ...
  "sessionTree.abort": "Abort",
  "sessionTree.agentPlaceholder": "Agent",
  "sessionTree.clear": "Clear",
  "sessionTree.column.additions": "Added",
  "sessionTree.column.deletions": "Deleted",
  "sessionTree.column.messages": "Messages",
  "sessionTree.column.session": "Session",
  "sessionTree.includeCompleted": "Include completed",
  "sessionTree.modelPlaceholder": "Model",
  "sessionTree.noResumable": "No resumable sessions selected",
  "sessionTree.noResumable.description":
    "Enable completed sessions if you want to send resume commands to completed or idle sessions.",
  "sessionTree.open": "Session tree",
  "sessionTree.providerPlaceholder": "Provider",
  "sessionTree.reasonPlaceholder": "Reason",
  "sessionTree.resume": "Resume",
  "sessionTree.resumeDialog.confirm": "Resume",
  "sessionTree.resumeDialog.count": "{{count}} selected sessions",
  "sessionTree.resumeDialog.defaultMessage":
    "Continue from the last recoverable state. If recovery is not possible, report the blocker and the next required action.",
  "sessionTree.resumeDialog.message": "Send a resume message",
  "sessionTree.resumeDialog.message.description":
    "Add a structured user message and ask the model to continue. Use this for idle or completed sessions that need new instructions.",
  ...
  "sessionTree.selectResumable": "Select resumable",
  "sessionTree.statusAll": "All statuses",
  "sessionTree.title": "Session tree",
  "sessionTree.titlePlaceholder": "Title",
  "sessionTree.update": "Update",
  "sessionTree.updated": "Updated {{count}} sessions",
  "sessionTree.confirmAgent.title": "Replace bound agent",
  "sessionTree.confirmAgent.description":
    "These sessions already have a bound agent. Replacing it will change the agent used when they are resumed or restarted.",
  ...
  "sidebar.gettingStarted.line1": "Open Agent Harness includes free models so you can start immediately.",
  ...
  "app.name.desktop": "Open Agent Harness Desktop",
  ...
  "settings.desktop.wsl.description": "Run the Open Agent Harness server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Open Agent Harness",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Open Agent Harness looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description":
    "Choose whether Open Agent Harness follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Open Agent Harness is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Open Agent Harness launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Open Agent Harness.",
