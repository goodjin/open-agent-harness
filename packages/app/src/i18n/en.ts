export const dict = {
  ...
  "session.runs.title": "Runs",
  "session.runs.count": "{{count}} protocol runs",
  "session.runs.loading": "Loading runs...",
  "session.runs.empty": "No protocol runs in this session yet",
  "session.runs.error": "Unable to load session runs",
  "session.runs.refresh": "Refresh",
  "session.runs.summary": "{{done}}/{{tasks}} tasks completed · {{documents}} documents",
  "session.runs.tasks": "Tasks",
  "session.runs.depends": "Depends on {{ids}}",
  "session.runs.documents": "Documents",
  "session.runs.noDocuments": "No planning documents recorded for this run",
