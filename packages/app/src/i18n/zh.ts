...
export const dict = {
  ...
  "dialog.provider.opencode.note": "使用 Open Agent Harness Zen 或 API 密钥连接",
  ...
  "dialog.model.unpaid.freeModels.title": "Open Agent Harness 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Open Agent Harness 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "Open Agent Harness Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " 获取授权码，以连接你的帐户并在 Open Agent Harness 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 并输入以下代码，以连接你的帐户并在 Open Agent Harness 中使用 {{provider}} 模型。",
  ...
  "provider.custom.field.concurrency.label": "提供商并发",
  "provider.custom.field.concurrency.placeholder": "可选",
  "provider.custom.field.concurrency.description": "该提供商允许同时发起的模型请求数。",
  "provider.custom.field.rpm.label": "提供商 RPM",
  "provider.custom.field.rpm.placeholder": "可选",
  "provider.custom.field.rpm.description": "该提供商每分钟允许发起的模型请求数。",
  ...
  "provider.custom.models.concurrency.label": "并发",
  "provider.custom.models.concurrency.placeholder": "上限",
  ...
  "provider.custom.error.concurrency": "请输入正整数",
  "provider.custom.error.rpm": "请输入正整数",
  ...
  "prompt.confirmAgent.title": "替换绑定智能体",
  "prompt.confirmAgent.description": "这个会话已经绑定了其他智能体。替换后，本次请求继续前会改用新的智能体。",
  "prompt.confirmAgent.confirm": "替换智能体",
  "prompt.confirmModel.title": "替换绑定模型",
  "prompt.confirmModel.description": "这个会话已经绑定了其他模型。替换后，本次请求继续前会更新会话模型。",
  "prompt.confirmModel.confirm": "替换模型",
  ...
  "prompt.toast.agentRequired.title": "请选择智能体",
  "prompt.toast.agentRequired.description": "发送提示前请先选择智能体。",
  ...
  "dialog.server.description": "切换此应用连接的 Open Agent Harness 服务器。",
  ...
  "toast.update.description": "Open Agent Harness 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Open Agent Harness 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Open Agent Harness 暂不支持 MCP 认证。',
  ...
  "session.tab.timeline": "时间线",
  "session.tab.logs": "日志",
  "session.tab.runs": "运行记录",
  "session.tab.task": "任务",
  ...
  "session.logs.empty": "此会话暂无日志",
  "session.logs.error": "无法加载会话日志",
  "session.logs.refresh": "刷新",
  ...
  "session.logs.stats.reasoning": "思考",
  "session.logs.stats.cacheRead": "缓存读",
  "session.logs.stats.cacheWrite": "缓存写",
  "session.runs.title": "任务",
  "session.runs.count": "{{count}} 个任务",
  "session.runs.loading": "正在加载任务...",
  "session.runs.empty": "当前会话暂无任务",
  "session.runs.error": "无法加载会话运行记录",
  "session.runs.refresh": "刷新",
  "session.runs.task": "任务内容",
  "session.runs.result": "运行结果",
  "session.runs.execution": "执行信息",
  "session.runs.recorded": "已记录",
  "session.runs.fallback": "回退结果",
  "session.runs.fallbackHint": "来源：子会话结果未能正常记录后生成的回退摘要。",
  "session.runs.missingResult": "未记录最终结果",
  "session.runs.running": "运行中",
  "session.runs.status.running": "运行中",
  "session.runs.status.completed": "已完成",
  "session.runs.status.blocked": "已阻塞",
  "session.runs.status.failed": "失败",
  "session.runs.runID": "运行 ID {{id}}",
  "session.runs.started": "开始于 {{time}}",
  "session.runs.completedAt": "完成于 {{time}}",
  "session.runs.documentCount": "{{count}} 份文档",
  "session.runs.startedLabel": "开始时间",
  "session.runs.completed": "完成时间",
  "session.runs.progressLabel": "进度",
  "session.runs.progress": "已完成 {{done}}/{{total}} 个子任务",
  "session.runs.duration": "耗时",
  "session.runs.metrics": "指标",
  "session.runs.metricActions": "{{count}} 个动作",
  "session.runs.metricInternal": "{{count}} 次内部工具调用",
  "session.runs.metricModel": "{{count}} 次模型工具调用",
  "session.runs.metricVisible": "{{count}} 可见字节",
  "session.runs.metricRaw": "{{count}} 原始字节",
  "session.runs.executionSummary": "执行器摘要",
  "session.runs.tasks": "子任务",
  "session.runs.depends": "依赖 {{ids}}",
  "session.runs.documents": "文档",
  "session.runs.noDocuments": "这个任务没有记录文档",
  "session.runs.documentLoading": "正在加载文档...",
  "session.runs.documentError": "无法加载文档",
  "session.runs.back": "返回运行详情",
  "session.task.loading": "正在加载当前任务...",
  "session.task.current": "当前任务",
  "session.task.archived": "归档版本 {{version}}",
  "session.task.meta": "版本 {{version}} · 更新于 {{time}}",
  "session.task.history": "查看历史",
  "session.task.return": "返回当前任务",
  "session.task.progress": "执行进度与子任务",
  "session.task.progressValue": "已完成 {{completed}}/{{total}} 个 action",
  "session.task.result": "任务结果",
  "session.task.result.running": "当前任务仍在执行（已完成 {{completed}}/{{total}} 个 action）。",
  "session.task.result.recorded": "已记录结果",
  "session.task.result.fallback": "回退结果",
  "session.task.result.missing": "未记录最终结果",
  "session.task.handoffs": "相关 Handoff",
  "session.task.handoffs.empty": "暂无相关 Handoff",
  "session.task.handoff.target": "目标会话 {{session}}",
  "session.task.handoff.proposed": "待确认",
  "session.task.handoff.confirmed": "已确认",
  "session.task.handoff.creating": "创建中",
  "session.task.handoff.started": "已启动",
  "session.task.handoff.failed": "失败",
  "session.task.handoff.cancelled": "已取消",
  "session.task.proposal.update": "任务更新提案",
  "session.task.proposal.handoff": "任务 Handoff 提案",
  "session.task.proposal.children": "受影响的子会话：{{sessions}}",
  "session.task.proposal.ownership": "任务归属：当前会话树之外的独立同级任务。",
  "session.task.proposal.refs": "可复用上下文：{{refs}}",
  "session.task.proposal.confirm": "确认",
  "session.task.proposal.retry": "重试",
  "session.task.proposal.discuss": "继续讨论",
  "session.task.proposal.cancel": "取消提案",
  "session.task.proposal.openTarget": "打开目标会话",
  "session.task.proposal.status.proposed": "待确认",
  "session.task.proposal.status.confirming": "确认中",
  "session.task.proposal.status.revising": "修订中",
  "session.task.proposal.status.creating": "创建中",
  "session.task.proposal.status.started": "已启动",
  "session.task.proposal.status.failed": "失败",
  "session.task.proposal.status.cancelled": "已取消",
  "session.task.action.pending": "待执行",
  "session.task.action.running": "执行中",
  "session.task.action.completed": "已完成",
  "session.task.action.blocked": "已阻塞",
  "session.task.action.failed": "失败",
  "session.task.action.skipped": "已跳过",
  "session.task.history.loading": "正在加载任务历史...",
  "session.task.history.empty": "暂无归档任务版本",
  "session.task.history.version": "版本 {{version}}",
  "session.task.history.terminal": "终态：{{status}}",
  "session.task.history.stopped": "已停止子任务：{{count}}",
  "session.task.history.result": "结果：{{status}}",
  "session.task.history.result.completed": "完整",
  "session.task.history.result.partial": "部分",
  "session.task.history.result.failed": "失败",
  "session.task.history.result.missing": "未记录",
  "session.task.detail.loading": "正在加载归档版本...",
  "session.task.unbound.title": "尚未生成任务",
  ...
  "session.task.status.revising": "修订中",
  "session.task.status.blocked": "已阻塞",
  "session.task.status.completed": "已完成",
  "session.task.status.failed": "失败",
  "session.task.status.archived": "已归档",
  "session.task.error.current": "无法加载当前任务",
  "session.task.error.history": "无法加载任务历史",
  "session.task.error.detail": "无法加载归档版本",
  ...
  "session.followupDock.target": "回复到 {{target}}",
  ...
  "sessionTree.abort": "中止",
  "sessionTree.agentPlaceholder": "智能体",
  "sessionTree.clear": "清空",
  "sessionTree.column.additions": "新增行",
  "sessionTree.column.deletions": "删除行",
  "sessionTree.column.messages": "消息数",
  "sessionTree.column.session": "会话",
  "sessionTree.includeCompleted": "包含已完成",
  "sessionTree.modelPlaceholder": "模型",
  "sessionTree.noResumable": "没有可继续的会话",
  "sessionTree.noResumable.description": "如果要给已完成或空闲会话发送继续命令，请先勾选包含已完成。",
  "sessionTree.open": "会话树",
  "sessionTree.providerPlaceholder": "Provider",
  "sessionTree.reasonPlaceholder": "原因",
  "sessionTree.resume": "继续",
  "sessionTree.resumeDialog.confirm": "继续",
  "sessionTree.resumeDialog.count": "已选择 {{count}} 个会话",
  "sessionTree.resumeDialog.defaultMessage": "从最近可恢复状态继续。如果无法恢复，请说明阻塞原因和下一步需要的动作。",
  "sessionTree.resumeDialog.message": "发送消息继续",
  "sessionTree.resumeDialog.message.description":
    "添加一条结构化用户消息，让模型继续处理。适合空闲或已完成但需要新指令的会话。",
  ...
  "sessionTree.selectResumable": "选择可继续",
  "sessionTree.statusAll": "全部状态",
  "sessionTree.title": "会话树",
  "sessionTree.titlePlaceholder": "标题",
  "sessionTree.update": "更新",
  "sessionTree.updated": "已更新 {{count}} 个会话",
  "sessionTree.confirmAgent.title": "替换绑定智能体",
  "sessionTree.confirmAgent.description": "这些会话已经绑定了智能体。替换后，继续或重启会话时会使用新的智能体。",
  "sessionTree.confirmAgent.current": "当前：{{current}}",
  "sessionTree.confirmAgent.next": "新智能体：{{next}}",
  "sessionTree.confirmAgent.confirm": "替换智能体",
  "sessionTree.confirmModel.title": "替换绑定模型",
  "sessionTree.confirmModel.description": "选中的会话可能已经绑定了模型。替换后，后续继续会话时会使用新的模型。",
  "sessionTree.confirmModel.current": "当前：{{current}}",
  "sessionTree.confirmModel.next": "新模型：{{next}}",
  "sessionTree.confirmModel.confirm": "替换模型",
  ...
  "sidebar.gettingStarted.line1": "Open Agent Harness 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Open Agent Harness 服务器。",
  ...
  "settings.general.row.language.description": "更改 Open Agent Harness 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 Open Agent Harness 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Open Agent Harness 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Open Agent Harness 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Open Agent Harness 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Open Agent Harness。",
