...
export const dict = {
  ...
  "session.runs.title": "运行记录",
  "session.runs.count": "{{count}} 个协议运行",
  "session.runs.loading": "正在加载运行记录...",
  "session.runs.empty": "当前会话暂无协议运行记录",
  "session.runs.error": "无法加载会话运行记录",
  "session.runs.refresh": "刷新",
  "session.runs.summary": "已完成 {{done}}/{{tasks}} 个任务 · {{documents}} 份文档",
  "session.runs.tasks": "任务",
  "session.runs.depends": "依赖 {{ids}}",
  "session.runs.documents": "文档",
  "session.runs.noDocuments": "这个运行记录中没有规划文档",
