export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Open Agent Harness",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Open Agent Harness-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "Open Agent Harness Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Open Agent Harness-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Open Agent Harness-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Open Agent Harness server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Open Agent Harness-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Open Agent Harness timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Open Agent Harness još ne podržava MCP autentifikaciju.',
  ...
  "session.followupDock.target": "Odgovor na {{target}}",
  ...
  "sidebar.gettingStarted.line1": "Open Agent Harness uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Open Agent Harness server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Open Agent Harness-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Open Agent Harness izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Open Agent Harness prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Open Agent Harness-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Open Agent Harness pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Open Agent Harness-a.",
