...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Open Agent Harness",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Open Agent Harness.",
  ...
  "provider.connect.opencodeZen.line1":
    "Open Agent Harness Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Open Agent Harness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Open Agent Harness.",
  ...
  "dialog.server.description": "Bytt hvilken Open Agent Harness-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Open Agent Harness ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Open Agent Harness-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Open Agent Harness ikke støtter MCP-autentisering ennå.',
  ...
  "session.followupDock.target": "Svarer til {{target}}",
  ...
  "sidebar.gettingStarted.line1": "Open Agent Harness inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Open Agent Harness-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Open Agent Harness",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Open Agent Harness ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Open Agent Harness skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Open Agent Harness er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Open Agent Harness starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Open Agent Harness.",
