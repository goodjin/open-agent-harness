export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Open Agent Harness",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Open Agent Harness.",
  ...
  "provider.connect.opencodeZen.line1":
    "Open Agent Harness Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Open Agent Harness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Open Agent Harness.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Open Agent Harness se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Open Agent Harness ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Open Agent Harness",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Open Agent Harness no soporta autenticación MCP todavía.',
  ...
  "session.followupDock.target": "Respondiendo a {{target}}",
  ...
  "sidebar.gettingStarted.line1": "Open Agent Harness incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Open Agent Harness dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Open Agent Harness",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Open Agent Harness en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Open Agent Harness sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Open Agent Harness.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Open Agent Harness",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Open Agent Harness.",
