...
beforeAll(async () => {
  ...
  mock.module("@open-agent-harness/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@open-agent-harness/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@open-agent-harness/ui/icon", () => ({ Icon: () => null }))
  mock.module("@open-agent-harness/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
