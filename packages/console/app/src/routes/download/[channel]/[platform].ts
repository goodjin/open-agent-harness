...
const downloadNames: Record<string, string> = {
  "darwin-aarch64-dmg": "Open Agent Harness Desktop.dmg",
  "darwin-x64-dmg": "Open Agent Harness Desktop.dmg",
  "windows-x64-nsis": "Open Agent Harness Desktop Installer.exe",
