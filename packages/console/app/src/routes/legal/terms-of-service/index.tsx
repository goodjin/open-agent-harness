...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>Open Agent Harness | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="Open Agent Harness terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to Open Agent Harness. Please read on to learn the rules and restrictions that govern your use of
                Open Agent Harness&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("Open Agent Harness," "we" and "us"). Your use of the Services in any
              ...
              <h2 id="what-is-opencode">What is Open Agent Harness?</h2>
              <p>
                Open Agent Harness is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the Open Agent Harness Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, Open Agent Harness enables you to
              ...
              <p>
                Open Agent Harness takes the privacy of its users very seriously. For the current Open Agent Harness Privacy Policy, please
                click here{" "}
              ...
              <h2 id="what-are-the-basics">What are the basics of using Open Agent Harness?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by Open Agent Harness;
                </li>
                <li>
              ...
              <p>
                If you use Open Agent Harness with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                Open Agent Harness. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                Open Agent Harness has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-opencode-ever-change-the-services">Will Open Agent Harness ever change the Services?</h2>
              <p>
              ...
              <p>
                Open Agent Harness is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. Open Agent Harness has the sole right to decide whether you are
              ...
              <p>
                Open Agent Harness and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (Open Agent Harness and all such
                parties together, the "Open Agent Harness Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the Open Agent Harness Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The Open Agent Harness Parties make no representations or warranties regarding
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the Open Agent Harness Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without Open Agent Harness's prior written
              ...
              <p>
                ...
                disputes and claims with Open Agent Harness and limits the manner in which you can seek relief from Open Agent Harness. Both
                you and Open Agent Harness acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, Open Agent Harness's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. Open Agent Harness will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. Open Agent Harness will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or Open Agent Harness may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                ...
                OF A JUDGE OR JURY. You and Open Agent Harness are instead choosing to have claims and disputes resolved by
                ...
                you and Open Agent Harness over whether to vacate or enforce an arbitration award, YOU AND OPENCODE WAIVE ALL
              ...
              <p>
                ...
                Open Agent Harness is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or Open Agent Harness to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and Open Agent Harness agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                relationship with Open Agent Harness.
              </p>
              ...
              <p>
                ...
                the Open Agent Harness may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and Open Agent Harness agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and Open Agent Harness, and
                ...
                are not an employee, agent, partner, or joint venture of Open Agent Harness, and you do not have any authority of
                any kind to bind Open Agent Harness in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and Open Agent Harness
