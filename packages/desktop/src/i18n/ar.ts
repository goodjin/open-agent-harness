export const dict = {
  ...
  "desktop.menu.help.documentation": "وثائق Open Agent Harness",
  ...
  "desktop.cli.error.sidecarMissing": "ملف Open Agent Harness CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
