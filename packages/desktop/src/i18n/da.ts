export const dict = {
  ...
  "desktop.menu.help.documentation": "Open Agent Harness Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing": "Open Agent Harness CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
