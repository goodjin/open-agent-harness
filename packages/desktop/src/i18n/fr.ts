export const dict = {
  ...
  "desktop.menu.help.documentation": "Documentation d'Open Agent Harness",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI Open Agent Harness est manquant. Essayez de réinstaller l'application de bureau.",
