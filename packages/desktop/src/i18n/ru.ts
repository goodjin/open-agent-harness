export const dict = {
  ...
  "desktop.menu.help.documentation": "Документация Open Agent Harness",
  ...
  "desktop.cli.error.sidecarMissing":
    "Отсутствует бинарный файл Open Agent Harness CLI. Попробуйте переустановить настольное приложение.",
