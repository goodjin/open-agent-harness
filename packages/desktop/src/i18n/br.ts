export const dict = {
  ...
  "desktop.menu.help.documentation": "Documentação do Open Agent Harness",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do Open Agent Harness está ausente. Tente reinstalar o aplicativo de desktop.",
