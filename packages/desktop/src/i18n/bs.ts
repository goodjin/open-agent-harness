export const dict = {
  ...
  "desktop.menu.help.documentation": "Open Agent Harness Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka Open Agent Harness CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
