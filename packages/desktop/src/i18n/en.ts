export const dict = {
  ...
  "desktop.menu.help.documentation": "Open Agent Harness Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "Open Agent Harness CLI binary is missing. Try reinstalling the desktop app.",
