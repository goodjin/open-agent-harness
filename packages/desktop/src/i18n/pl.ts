export const dict = {
  ...
  "desktop.menu.help.documentation": "Dokumentacja Open Agent Harness",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego Open Agent Harness CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
