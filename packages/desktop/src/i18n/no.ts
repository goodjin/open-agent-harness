export const dict = {
  ...
  "desktop.menu.app": "Open Agent Harness",
  ...
  "desktop.menu.help.documentation": "Open Agent Harness Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "Open Agent Harness CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
