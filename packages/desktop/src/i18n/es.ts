export const dict = {
  ...
  "desktop.menu.help.documentation": "Documentación de Open Agent Harness",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de Open Agent Harness. Intenta reinstalar la aplicación de escritorio.",
