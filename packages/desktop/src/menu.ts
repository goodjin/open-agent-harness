    ...
    items: [
      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/goodjin/open-agent-harness#readme"),
            text: t("desktop.menu.help.documentation"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/goodjin/open-agent-harness/issues"),
          ...
          await MenuItem.new({
            action: () =>
              openUrl("https://github.com/goodjin/open-agent-harness/issues/new?template=feature-request.yml"),
            text: t("desktop.menu.help.shareFeedback"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/goodjin/open-agent-harness/issues/new?template=bug-report.yml"),
