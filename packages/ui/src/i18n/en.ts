export const dict: Record<string, string> = {
  ...
  "ui.sessionTurn.status.thinkingDone": "Thinking finished",
  "ui.sessionTurn.status.responseStreaming": "Text output streaming",
  "ui.sessionTurn.status.responseDone": "Text output finished",
  "ui.sessionTurn.status.toolStreaming": "Tool call output streaming",
  "ui.sessionTurn.status.toolDone": "Tool call output finished",
