export const dict: Record<string, string> = {
  ...
  "ui.messagePart.collapsed.ignoredText.description": "This content was streamed while the model was working, then hidden from the final response view.",
  "ui.messagePart.collapsed.reasoning.title": "Reasoning summary",
  "ui.messagePart.collapsed.reasoning.description": "This reasoning content is collapsed because reasoning summaries are disabled.",
