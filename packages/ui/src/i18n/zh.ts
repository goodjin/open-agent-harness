...
export const dict = {
  ...
  "ui.sessionTurn.status.thinkingDone": "思考结束",
  "ui.sessionTurn.status.responseStreaming": "文本输出中",
  "ui.sessionTurn.status.responseDone": "文本输出结束",
  "ui.sessionTurn.status.toolStreaming": "工具调用输出中",
  "ui.sessionTurn.status.toolDone": "工具调用输出结束",
  ...
  "ui.messagePart.title.thinkingProcess": "思考过程",
