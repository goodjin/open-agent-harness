...
export namespace Agent {
  ...
  async function transformToInfo(template: {
    ...
    return {
      ...
      verification: template.meta.verification,
      runner: template.meta.runner,
      concurrency: template.meta.concurrency,
      maxToolCalls: template.meta.maxToolCalls,
  ...
  function overlay(name: string, info: Info | undefined, cfg: Config.Agent | undefined): Info | undefined {
    ...
    return {
      ...
      maxToolCalls: cfg.maxToolCalls ?? next.maxToolCalls,
