export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Open Agent Harness",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Open Agent Harness wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
