export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do Open Agent Harness",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do Open Agent Harness foi baixada. Você gostaria de instalá-la e reiniciar?",
