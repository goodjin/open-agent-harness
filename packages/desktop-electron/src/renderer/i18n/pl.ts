export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Open Agent Harness",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Open Agent Harness. Czy chcesz ją zainstalować i uruchomić ponownie?",
