export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Open Agent Harness",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Open Agent Harness er lastet ned. Vil du installere den og starte på nytt?",
