export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Open Agent Harness-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Open Agent Harness-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
