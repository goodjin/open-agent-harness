export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of Open Agent Harness",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Open Agent Harness has been downloaded, would you like to install it and relaunch?",
