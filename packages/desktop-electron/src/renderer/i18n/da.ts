export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Open Agent Harness",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Open Agent Harness er blevet downloadet. Vil du installere den og genstarte?",
