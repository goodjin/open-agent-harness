export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Open Agent Harness",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Open Agent Harness a été téléchargée. Voulez-vous l'installer et redémarrer ?",
