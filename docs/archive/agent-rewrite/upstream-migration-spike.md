...
- `script/dev-web.ts`
- untracked Agent Protocol DSL docs under `docs/archive/agent-rewrite/09-*`, `10-*`, `11-*`, and `references/`
...
| `packages/app` | `@open-agent-harness/app@1.2.27` | `@open-agent-harness/app@1.15.7` |
| `packages/web` | `@open-agent-harness/web@1.2.27` | `@open-agent-harness/web@1.15.7` |
| `packages/sdk/js` | `@open-agent-harness/sdk@1.2.27` | `@open-agent-harness/sdk@1.15.7` |
...
- upstream introduces workspace packages `@open-agent-harness/core`, `@open-agent-harness/llm`, `@open-agent-harness/plugin`, `@open-agent-harness/ui`
- upstream removes current fork dependency on `@open-agent-harness/util` and old Hono validator packages
...
- local docs: `docs/archive/agent-rewrite/03-plugin-removal.md`, `docs/archive/agent-rewrite/01-baseline-stabilization.md`
...
- `docs/archive/agent-rewrite/01-baseline-stabilization.md` records deleted skill source/tests and replacement coverage.
