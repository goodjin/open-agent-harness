...
本目录保存 Agent Harness 相关外部资料的来源索引、摘要和协议对照笔记。
...
- `harness-reference-comparison.md`：外部资料与 Open Agent Harness 治理协议的差异对照。

## 使用方式

这些资料用于支撑 `docs/harness-protocol/00-harness-governance-protocol.md` 及后续子协议设计。阅读顺序建议：

1. 先看 `harness-reference-comparison.md`，理解外部资料与本协议的关系。
2. 再看 OpenAI 与 Anthropic 的资料笔记，提取可进入协议的设计要点。
3. 最后看微信文章笔记，作为行业通用组件分类和术语对照。
