...
| 01 | `01-agent-model-and-authoring.md` | Agent 定义、Skill 来源导入、metadata、entry、capability、permission、relationships 和 authoring contract。 |
...
- `01` 里的 `SKILL.md` 内容只说明一种 Agent 来源格式；运行时协议对象仍是 Agent。
